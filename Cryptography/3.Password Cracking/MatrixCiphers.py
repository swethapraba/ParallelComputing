...
def get_decryption_matrix(P,C, a):
    """ Knowing two digraphs in string P are encoded as string C, determine
        a unique decryption matrix, relative to Cryptoalpha a """
    ...
    cdioneN = a.stoa(pdione) #make letters into numbers list
    ...
    cipherinverse = ciphermatrixnums.inv()
    #multiply plain with the cipher inverse to get d
    D = plainmatrixnums*cipherinverse
    return D
